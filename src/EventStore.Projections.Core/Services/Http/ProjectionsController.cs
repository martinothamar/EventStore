	...
	public class ProjectionsController : CommunicationController {
		...
		protected override void SubscribeCore(IHttpService service) {
			...
			Register(service, "/projection/{name}/query?type={type}&emit={emit}",
				HttpMethod.Put, OnProjectionQueryPut, new ICodec[] {Codec.ManualEncoding}, SupportedCodecs, AuthorizationLevel.Ops);
			...
			Register(service, "/projection/{name}/command/disable?enableRunAs={enableRunAs}",
				HttpMethod.Post, OnProjectionCommandDisable, Codec.NoCodecs, SupportedCodecs, AuthorizationLevel.Ops);
			Register(service, "/projection/{name}/command/enable?enableRunAs={enableRunAs}",
				HttpMethod.Post, OnProjectionCommandEnable, Codec.NoCodecs, SupportedCodecs, AuthorizationLevel.Ops);
			Register(service, "/projection/{name}/command/reset?enableRunAs={enableRunAs}",
				HttpMethod.Post, OnProjectionCommandReset, Codec.NoCodecs, SupportedCodecs, AuthorizationLevel.Ops);
			Register(service, "/projection/{name}/command/abort?enableRunAs={enableRunAs}",
				HttpMethod.Post, OnProjectionCommandAbort, Codec.NoCodecs, SupportedCodecs, AuthorizationLevel.Ops);
